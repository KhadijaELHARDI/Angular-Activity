...
export class ProductService {
 ...
 return this.http.get<Array<any>>(`http://localhost:3000/products?_page=${page}&_limit=${size}`);
  ...
  public searchProducts(keyword:string):Observable<Array<Product>>{
    return this.http.get<Array<any>>(`http://localhost:3000/products?name_like=${keyword}`);
